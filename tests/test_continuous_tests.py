...
class TestStatTests(unittest.TestCase):
    ...
    def test_additional_vars_reg_one_var_test(self):
        test_sr = generate_data(100)
        test_additional_var = generate_data(100, index=test_sr.index).rename("var_1")
        control_sr = generate_data(100)
        control_additional_var = generate_data(100, index=control_sr.index).rename("var_1")
    ...
    def test_additional_vars_reg_multiple_vars_test(self):
        test_sr = generate_data(100)
        test_additional_var1 = generate_data(100, index=test_sr.index).rename("var_1")
        test_additional_var2 = generate_data(100, index=test_sr.index).rename("var_1")
        control_sr = generate_data(100)
        control_additional_var1 = generate_data(100, index=control_sr.index).rename("var_1")
        control_additional_var2 = generate_data(100, index=control_sr.index).rename("var_1")
        p_value = additional_vars_regression_test(
            control_sr,
    ...
    def test_cuped_ttest(self):
        test_sr = generate_data(100)
        test_covariant_sr = generate_data(100, index=test_sr.index).rename("var_1")
        control_sr = generate_data(100)
        control_covariant_sr = generate_data(100, index=control_sr.index).rename("var_1")
        p_value = cuped_ttest(
            control_sr,
